...
\begin{column}{0.45\textwidth} 
\begin{center}
\includegraphics[scale=0.25]{images/dcn-arch.png}
\end{center}
\end{column}
\begin{column}{0.45\textwidth}
\begin{center}
\includegraphics[scale=0.25]{images/dcn-block.png}
\end{center}
\end{column}
\end{columns}
...
\begin{center}
\includegraphics[scale=0.13]{images/dlrm-arch.png}
\end{center}
\end{column}
\begin{column}{0.65\textwidth}
\begin{center}
\includegraphics[scale=0.08]{images/dlrm-parallel.png}
\end{center}
\end{column}
\end{columns}
